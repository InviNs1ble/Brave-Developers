...
let AuthService = class AuthService {
    ...
    async registration(userDto) {
        ...
        if (candidate) {
            throw new exceptions_1.HttpException('Пользователь с таким именем уже существует', enums_1.HttpStatus.BAD_REQUEST);
        }
    ...
    async validateUser(userDto) {
        ...
        throw new exceptions_1.UnauthorizedException({ message: 'Неверный email или пароль' });
    }
};
